package com.seezoon.web.component;
...
public class RestTemplateCustomConfiguration {
    ...
    public HttpClientConnectionManager poolingConnectionManager() {
        ...
        poolingConnectionManager.setDefaultSocketConfig(
                SocketConfig.custom().setSoTimeout(seezoonProperties.getHttp().getSocketTimeout()).setSoKeepAlive(true)
                        .build());
        ...
        // 空闲扫描线程
        HttpClientIdleConnectionMonitor
                .registerConnectionManager(poolingConnectionManager, seezoonProperties.getHttp().getIdleTimeToDead(),
                        seezoonProperties.getHttp().getIdleScanTime());
    ...
    public HttpClientBuilder httpClientBuilder(SSLContext sslContext) {
        ...
        httpClientBuilder.setDefaultRequestConfig(requestConfig).setSSLContext(sslContext)
                ...
                .setConnectionTimeToLive(seezoonProperties.getHttp().getConnTimeToLive(),
                        TimeUnit.MILLISECONDS)// 连接最大存活时间
                // 默认重试次数为0，POST 不重试
                .setRetryHandler(
                        new StandardHttpRequestRetryHandler(seezoonProperties.getHttp().getRetyTimes(), false));
            ...
            while (true) {
                ...
                try {
                    ...
                    synchronized (HttpClientIdleConnectionMonitor.class) {
                        connectionManagers = (List<HttpClientConnectionManager>) HttpClientIdleConnectionMonitor.CONNECTION_MANAGERS
                                .clone();
                    }
